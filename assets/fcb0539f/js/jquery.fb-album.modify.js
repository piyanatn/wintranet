...
(function($) {
    $.fn.fbalbum = function(opts) {
        ...
        function albumCall() {
            FB.api(opts.pageId + '/albums', {
                ...
                if (typeof response.data == "undefined"){
                    $('#fb-albums-all').html(opts.emptyMsg);
        ...
        function photoCall() {
            FB.api(albumId + '/photos', {
                ...
                for(var i in response.data) {
                    ...
                    // add an icon view and select
                    html += '<div class="photoIcons">';
                ...
                if(response.data.length > 0) {
                    photoOffset++;
                    // initialize lightbox so we don't wait photos to be finish before initializing lightbox
        ...
        $("<div>", {
            ...
            html : 'Photos from <a target="_blank" href="http://www.facebook.com/' + opts.pageId + '">facebook.com/' + opts.pageId + '</a>'
        }).appendTo("#" + opts.id);
