...
class HosinfoUser extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('idcard, updatedby, father_cid, mother_cid, married_cid', 'length', 'max'=>13),
	...
	public function search()
	{
		...
		$criteria->compare('birtdate',$this->birtdate,true);
